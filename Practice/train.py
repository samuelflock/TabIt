...
class FeedForwardNet(nn.Module):
    ...
    def forward(self, input_data):
        flattened_input = self.flatten(input_data)
        logits = self.dense_layers(flattened_input)
...
if __name__ == "__main__":
    ...
    # save model
    torch.save(feed_forward_net.state_dict(), "models/feedforwardnet.pth")
    print("Trained feed forward net saved in Models Folder")